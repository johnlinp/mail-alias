...
$group = get_one("SELECT `group` FROM leader WHERE name = '$realname'");
?>
...
echo '
    <div data-role="navbar">
        <ul>
            <li><a href="group-aliases.php?group=' . $group . '" target="content" data-icon="grid" data-theme="c" id="group">' . $group . '</a></li>
